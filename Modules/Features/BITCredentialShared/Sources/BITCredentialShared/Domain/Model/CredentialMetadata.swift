...
public struct CredentialMetadataWrapper {
  ...
  public var selectedCredential: CredentialMetadata.CredentialsSupported?
  public var privateKeyIdentifier: UUID = .init()
...
extension CredentialMetadata {
  public struct CredentialDefinition: Codable, Equatable {
    ...
    public let credentialSubject: [Claim]
